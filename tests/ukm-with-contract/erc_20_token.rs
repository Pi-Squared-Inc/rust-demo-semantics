...
pub trait Erc20Token {
    ...
    fn s_total_supply(&self) -> ::single_value_mapper::SingleValueMapper<u64>;
    ...
    fn s_balances(&self, address: u64) -> ::single_value_mapper::SingleValueMapper<u64>;

    // #[view(getAllowances)]
    #[storage_mapper("balances")]
    fn s_allowances(&self, account: u64, spender: u64) -> ::single_value_mapper::SingleValueMapper<u64>;
